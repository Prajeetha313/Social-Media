            ...
            <div className='postCol1'>
                ...
                <div className='singlepostfooter' style={{paddingLeft:'10px'}}>
                        ...
                        <span style={{paddingLeft:'30px'}}>
                            {username === userName && 
                                    <Button onClick={deletePost} type="submit" style={{width:'200px', backgroundColor:'teal', color:'white'}}>
                                        DELETE POST
                                    </Button>
                            }
                        </span> 
                        ...
                        <span style={{paddingLeft:'20px'}}>
                            ...
                            <Popup trigger={<Button type="button" style={{width:'200px', backgroundColor:'teal', color:'white'}}>
                                EDIT POST 
                                </Button>
                              } modal>
